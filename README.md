...
The Incident Knowledge Assistant is designed to solve the problem of searching large incident repositories using traditional keyword search.

Instead of matching only keywords, the application understands the semantic meaning of user queries through vector embeddings.
...
7. Display Results in Streamlit Dashboard
   Installation
...
Or use another supported model, for example:
...
Place the incident dataset in the project's data directory, for example:
